...
const Navbar = () => {
    ...
    return (
        <nav className="flex w-full justify-center fixed">
            <div className={`${isMenuVisible ? 'hidden' : '-ml-4 mx-4 flex w-full lg:w-2/5 border-2 border-zinc-900 bg-gray-50/70 items-center justify-between px-4 py-2 rounded-full backdrop-blur-sm'}`}>
